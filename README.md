...
- Timestamp: `2022-06-12 03:19`
- Build ID: `4b28f7f0-bf8e-4c50-b8a9-eddabf0d7598`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/4b28f7f0-bf8e-4c50-b8a9-eddabf0d7598.git
$ cd 4b28f7f0-bf8e-4c50-b8a9-eddabf0d7598
```
